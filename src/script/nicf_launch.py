...
import numpy as np
import ipdb
from NICF import logger
from datetime import datetime
import sys
from NICF.util import get_objects,set_global_seeds,arg_parser
import NICF.envs as all_envs
import NICF.agents as all_agents
import NICF.functionApproximation as all_FA
import os
def str2bool(str=""):
    str = str.lower()
...
def main(args):
    ...
    dls.divide_data(args.percentage, task = args.task)
